        ...
        <div className="">
          ...
          <div className="max-h-[300px] overflow-auto">
            ...
            <div className="grid gap-6">
              <div className="flex gap-4">
                ...
                <div className="grid gap-1">
                  <div className="flex items-center gap-2">
                    <h3 className="font-bold">Srini SR</h3>
                  </div>
            ...
            <div className="mt-6 flex-gap-2">
              ...
              <Button className=" bg-black text-white rounded-[10px] hover:bg-gray-800 hover:shadow-lg transition-all duration-200 mt-2">Submit</Button>
            </div>
          </div>
        </div>
      </DialogContent>
